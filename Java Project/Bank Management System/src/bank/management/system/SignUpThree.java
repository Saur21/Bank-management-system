...
public class SignUpThree extends JFrame implements ActionListener{
    ...
    SignUpThree(String formno) {
        ...
        contentPanel.setPreferredSize(new Dimension(850, 1000));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            String cardnumber = "" + Math.abs ((random.nextLong() % 90000000L)+5040939600000000L);
            ...
            if(c1.isSelected()){
                ...
                faclity = faclity+ "Email & SMS Alerts";
            }else if(c5.isSelected()){
                faclity = faclity+ "CheckBook";
